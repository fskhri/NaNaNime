...
function animeSeason(season) {
    ...
    $.getJSON('https://api.jikan.moe/v4/seasons/'+ year +'/'+ season, function(data) {
...
function animeGendre(id) {
    ...
    $.getJSON('https://api.jikan.moe/v4/genres/anime/'+ id, function(data) {
...
function animeUpComing() {
    ...
    $.getJSON('https://api.jikan.moe/v4/seasons/upcoming', function(data) {
...
function animeTopAiring() {
    ...
    $.getJSON('https://api.jikan.moe/v4/recommendations/anime', function(data) {
        let result = data.top;
        ...
        $('#hero-title').html('Anime Recommendations '+ year);
...
$('#body').on('click', '#detail-anime',function() {
    ...
    $.getJSON('https://api.jikan.moe/v4/anime/id/full/'+id, function(data) {
